...
Битрикс CModule*/
Class miet_edition extends CModule {
    /*Обязательные свойства объекта модуля*/
    const MODULE_ID = "miet.edition";
    var $MODULE_ID = "miet.edition";
    var $MODULE_VERSION;
    ...
    function __construct()
    {
        ...
        $this->MODULE_NAME = GetMessage("miet.edition_MODULE_NAME");
        $this->MODULE_DESCRIPTION = GetMessage("miet.edition_MODULE_DESC");
        $this->PARTNER_NAME = GetMessage("miet.edition_PARTNER_NAME");
        $this->PARTNER_URI = GetMessage("miet.edition_PARTNER_URI");
    }
