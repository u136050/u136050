...
Битрикс CModule*/
Class miet_readings extends CModule {
    /*Обязательные свойства объекта модуля*/
    const MODULE_ID = "miet.readings";
    var $MODULE_ID = "miet.readings";
    var $MODULE_VERSION;
    ...
    function __construct()
    {
        ...
        $this->MODULE_NAME = GetMessage("miet.readings_MODULE_NAME");
        $this->MODULE_DESCRIPTION =
            GetMessage("miet.readings_MODULE_DESC");
        $this->PARTNER_NAME = GetMessage("miet.readings_PARTNER_NAME");
        $this->PARTNER_URI = GetMessage("miet.readings_PARTNER_URI");
    }
