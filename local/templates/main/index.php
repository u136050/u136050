    ...
    <div class="slide-holder">
        <div class="container">
            <ul class="slides">
                <li>
                    <div class="image">
                        <img class="large" src="<?=SITE_TEMPLATE_PATH;?>/_include/images/bg-image02.gif" alt="image description" width="275" height="307" />
                    </div>
                    <div class="text-box">
        ...
        <ul class="gallery">
            <li>
                ...
                <div class="product-holder">
                    <div class="image">
                        <a href="#"><img class="large" src="<?=SITE_TEMPLATE_PATH;?>/_include/images/bg-image03.jpg" alt="image description" width="180" height="91" /></a>
                    </div>
                    <div class="wrap">
                        <span class="price">Price: $20.20</span>
                        <ul class="stars">
                            <li><a href="#"><img src="<?=SITE_TEMPLATE_PATH;?>/_include/images/star.gif" alt="image description" width="15" height="15" /></a></li>
                            <li><a href="#"><img src="<?=SITE_TEMPLATE_PATH;?>/_include/images/star.gif" alt="image description" width="15" height="15" /></a></li>
                            <li><a href="#"><img src="<?=SITE_TEMPLATE_PATH;?>/_include/images/star02.gif" alt="image description" width="15" height="15" /></a></li>
                            <li><a href="#"><img src="<?=SITE_TEMPLATE_PATH;?>/_include/images/star03.gif" alt="image description" width="15" height="15" /></a></li>
                            <li><a href="#"><img src="<?=SITE_TEMPLATE_PATH;?>/_include/images/star03.gif" alt="image description" width="15" height="15" /></a></li>
                        </ul>
                    </div>
                    <div class="stick">
                        <img src="<?=SITE_TEMPLATE_PATH;?>/_include/images/stick-green.png" alt="image description" width="82" height="82" />
                    </div>
                ...
                <div class="product-holder">
                    ...
                    <div class="stick">
                        <img src="<?=SITE_TEMPLATE_PATH;?>/_include/images/stick-violet.png" alt="image description" width="82" height="82" />
                    </div>
                    <div class="hotspot"></div>
                </div>
            </li><li>
                ...
                <div class="product-holder">
                    ...
                    <div class="stick">
                        <img src="<?=SITE_TEMPLATE_PATH;?>/_include/images/stick-blue.png" alt="image description" width="82" height="82" />
                    </div>
                    <div class="hotspot"></div>
                </div>
            </li><li>
                ...
                <div class="product-holder">
                    ...
                    <div class="stick">
                        <img src="<?=SITE_TEMPLATE_PATH;?>/_include/images/stick-orange.png" alt="image description" width="82" height="82" />
                    </div>
                    <div class="hotspot"></div>
                </div>
            </li><li>
