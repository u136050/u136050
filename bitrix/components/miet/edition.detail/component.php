...
global $USER;
###
\Bitrix\Main\Loader::includeModule('miet.edition');
use MIET\edition;
...
if($_REQUEST['saveKPI']) {
    if(KPI\KPIManager::SetKPIEmployee($arParams["USER_ID"],
        $_REQUEST['UF_EDITION_TITLE'], $_REQUEST['UF_ID_RATING_TITLE'], $_REQUEST['UF_ID_TYPE_EDITION'], $_REQUEST['UF_DATE_RECEIPED'], $_REQUEST['UF_QUANTITY'], $_REQUEST['UF_EDITOR'])) {
